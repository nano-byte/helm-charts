...
| `ingress.protocol`                        | `http`                     | The protocol used for ingress (`http` or `grpc`)                                                         |
...
| `monitoring.port`                         | `9100`                     | The port which is scraped for monitoring data                                                            |
| `monitoring.path`                         | `/metrics`                 | The path is scraped for monitoring data                                                                  |
